...
@Index("JQUO_DET12PK", ["quoDet12Pk"], { unique: true })
@Index("QUODETIN", ["quoDet1Fk", "delflag"], {})
@Entity("JSAL_QUO_DET12")
export class JsalQuoDet12 {
  @Column("number", {
    primary: true,
    name: "QUO_DET12PK",
    precision: 8,
  ...
  @ManyToOne(() => MasAccounts, (masAccounts) => masAccounts.jsalQuoDets)
