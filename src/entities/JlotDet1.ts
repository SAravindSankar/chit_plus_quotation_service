...
@Index(
  "ALPHATAG",
  ["prodIda", "prodTagno", "docfk", "tranDocfk", "delflag"],
  {}
)
@Index("ALTTAG1FK", ["alttagfk"], {})
@Index("BRANCHFKIN", ["branchfk"], {})
@Index(
  "GSDPSTKLDET1",
  [
    "delflag",
...
@Index("TAG_PK", ["tagPk"], { unique: true })
@Index("TLOTDET", ["prodfk", "rackfk"], {})
@Entity("JLOT_DET1")
export class JlotDet1 {
  @Column("number", { primary: true, name: "TAG_PK", precision: 8, scale: 0 })
  tagPk: number;
  ...
  tranDoc1Fk: number | null;

  @Column("number", { name: "DOC1FK", nullable: true, precision: 10, scale: 0 })
  doc1Fk: number | null;
