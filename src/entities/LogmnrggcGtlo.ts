...
@Index("LOGMNRGGC_GTLO_PK", ["logmnrUid", "keyobj", "baseobjv"], {
  unique: true,
})
@Index("LOGMNRGGC_I2GTLO", ["logmnrUid", "baseobj", "baseobjv"], {})
@Index("LOGMNRGGC_I3GTLO", ["logmnrUid", "dropScn"], {})
@Entity("LOGMNRGGC_GTLO")
