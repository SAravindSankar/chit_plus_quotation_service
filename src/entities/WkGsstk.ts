...
export class WkGsstk {
  ...
  aveRateVa: number | null;

  @Column("number", { name: "CL_PCS", nullable: true, precision: 12, scale: 2 })
  clPcs: number | null;
  ...
  @Column("number", { name: "CL_AMT", nullable: true, precision: 14, scale: 2 })
  clAmt: number | null;
