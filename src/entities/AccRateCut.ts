...
@Index("SYS_C007472", ["rateCutpk"], { unique: true })
@Entity("ACC_RATE_CUT")
export class AccRateCut {
  @Column("number", {
    primary: true,
    name: "RATE_CUTPK",
    precision: 8,
  ...
  @Column("char", { name: "RP_MODE", nullable: true, length: 1 })
  rpMode: string | null;

  @Column("number", { name: "RP_AMT", nullable: true, precision: 12, scale: 2 })
  rpAmt: number | null;
