...
@Entity("TOAD_PLAN_TABLE")
export class ToadPlanTable {
  @Column("varchar2", { name: "STATEMENT_ID", nullable: true, length: 30 })
  statementId: string | null;

  @Column("number", { name: "PLAN_ID", nullable: true })
  planId: number | null;

  @Column("date", { name: "TIMESTAMP", nullable: true })
  timestamp: Date | null;

  @Column("varchar2", { name: "REMARKS", nullable: true, length: 4000 })
  remarks: string | null;
  ...
  @Column("varchar2", { name: "OBJECT_ALIAS", nullable: true, length: 65 })
  objectAlias: string | null;
  ...
  @Column("number", { name: "DEPTH", nullable: true, scale: 0 })
  depth: number | null;
