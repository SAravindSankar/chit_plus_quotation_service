...
import { JsalRepairDet11 } from "./JsalRepairDet11";

@Index("JREPAIR_DET1PK", ["repairDet1Pk"], { unique: true })
@Entity("JSAL_REPAIR_DET1")
export class JsalRepairDet1 {
  @Column("number", {
    primary: true,
    name: "REPAIR_DET1PK",
    precision: 8,
  ...
  @ManyToOne(() => MasDoc, (masDoc) => masDoc.jsalRepairDets)
  @JoinColumn([{ name: "DOCFK", referencedColumnName: "docpk" }])
  docfk: MasDoc;

  @OneToMany(
    () => JsalRepairDet11,
    (jsalRepairDet11) => jsalRepairDet11.repairDet1Fk
  )
  jsalRepairDets: JsalRepairDet11[];
}
