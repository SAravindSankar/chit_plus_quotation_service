...
@Index("SYS_C0026105", ["tgrDbnDet2Pk"], { unique: true })
@Entity("TGR_DBN_DET2")
export class TgrDbnDet2 {
  @Column("number", {
    primary: true,
    name: "TGR_DBN_DET2PK",
    precision: 8,
  ...
  @ManyToOne(() => TgrDbn, (tgrDbn) => tgrDbn.tgrDbnDets)
  @JoinColumn([{ name: "TGR_DBNFK", referencedColumnName: "tgrDbnpk" }])
  tgrDbnfk: TgrDbn;
}
